...
const GUIDE_NOTES = new Map([
  [9001030, "攻略：风翎遁本体按位移技能处理；造成伤害的风袭作为独立“奇门衍生”卡展示。"],
  [9001039, "攻略：风袭为奇门衍生技，消耗1颗阴阳玉；蓝转按“本技能蓝耗 + 四技能蓝耗×1/4”修正。"],
  [9001031, "攻略：巽风遁为位移+旋风；直接伤害按9段展示，不耗蓝。"],
  [9001032, "攻略：玄风遁合为奇门衍生技，消耗1颗阴阳玉；按正常伤害3段展示，后续命中有大幅减伤。"],
  [9001036, "攻略：坤云遁为防守位移，云雾期间减伤99%；受到攻击时触发6段反击并致盲/暂停AI。"],
  [9001037, "攻略：云影双遁为奇门衍生位移，消耗1颗阴阳玉；生成化身并给后续两次伤害技能附加减速/暴击效果。"],
  [9001040, "攻略：玄空斩可取消后摇，攻转标记为净攻转；空中最多释放一次。"],
  [9001049, "攻略：天岚疾斩为奇门衍生技，消耗1颗阴阳玉；蓝转按“本技能蓝耗 + 四技能蓝耗×1/4”修正。"],
  [9001041, "攻略：九彩神石以11段直伤展示，无固伤；升级项为蓝耗和回复量，九彩琉璃回复量按实际成长数据展示。"],
  [9001042, "攻略：愈生之雀为奇门衍生技，消耗2颗阴阳玉；伤害范围为1段主伤 + 0~6段幼雀追击，按满6段追击展示。"],
  [9001046, "攻略：天机葫芦持续打击11段，并叠加断魂宝光；累积层数后扣除目标保护分。"],
  [9001047, "攻略：虚诈之蛇为奇门衍生技，消耗1颗阴阳玉；额外暗伤按目标伤势触发，小怪低血量可斩杀。"],
  [9001050, "攻略：灵剑千锋共13段，对同一目标第11~13段伤害大幅下降，因此按正常伤害10段展示。"],
  [9001058, "攻略：玄剑齐射为奇门衍生技，消耗3颗阴阳玉；第11段起大幅减伤，因此按10段展示。"],
  [9001051, "攻略：桃木剑势共26段，对同一目标第21段起大幅减伤，因此按正常伤害20段展示。"],
  [9001052, "攻略：肃杀之虎为奇门衍生技，消耗3颗阴阳玉；按猛扑1段 + 龙卷9段展示。"],
  [9001056, "攻略：照妖神镜按8段展示；定位为站桩输出，对不动目标收益较高。"],
  [9001057, "攻略：威悍之龙为奇门衍生技，消耗3颗阴阳玉；对免疫控制目标额外增伤10%。"],
  [9001060, "攻略：奇门遁阵开启阵法并凝聚4颗阴阳玉，上限7颗；阵内自身增伤10%，阵内敌人受玄女伤害+10%，持续90s。"],
  [9001061, "攻略：九天阵法范围扩大，凝聚5颗阴阳玉且上限+1，蓝耗+16.7%。"],
  [9001066, "攻略：九地阵法范围扩大，阵内友方防御力提升，蓝耗不变。"],
  [9001070, "攻略：化身元君变身后全程霸体，造成伤害+30%，受到伤害-30%；开启打击按4×atk强攻展示。"],
  [9001071, "攻略：兵魂天书在变身后召唤2位兵魂战将；兵魂血量继承玄女60%，其他属性100%。"],
  [9001076, "攻略：两仪宝伞在变身后附加10s护盾，自身护盾值=19%最大生命，友方按人数分摊。"],
  [9001211, "攻略：凌风诛邪不耗蓝，位移期间闪避大幅提升；只对处于攻击中的敌人触发3段风刃反击。"],
  [9001221, "攻略：灵雀缚罡同一目标第11段起大幅减伤，因此按10段展示；2s内可再次按键释放剑势化蛇。"],
  [9001223, "攻略：剑势化蛇为无双技能2二段；按1段展示，额外暗伤按目标伤势触发，小怪低血量可斩杀。"],
  [9001231, "攻略：双刺龙吟为无双技能3形态1，按7段戳刺 + 1段龙吟重击展示，并附加降低防御效果。"],
  [9001233, "攻略：玄锋虎啸为无双技能3形态2，二次按键触发；按7段戳刺 + 1段虎啸重击展示，并附加降低攻击效果。"],
  [9001241, "攻略：天渊剑墟按10段落剑 + 1段下坠展示；落剑无固伤，1.2s后可快速下坠收招。"],
]);
  ...
  const card = {
    ...
    levels: levels.map((l) => ({
      ...
      metrics: metrics.computeMetrics(
        ...
        { skillId: displaySkillId, level: l.level, roleLevel: l.roleLevel, consumeMp: l.consumeMp, totalPer: l.totalPer, totalVal: l.totalVal, healVal: displaySkillId === QICAI_STONE_SKILL_ID ? qicaiHealValue(ctx, l.level) : null, releaseSeconds: rel.releaseSeconds, segCount: l.segments.reduce((a, s) => a + s.maxHit, 0) },
